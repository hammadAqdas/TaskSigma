...
exports.switchDark = exports.signup = exports.logout = exports.login = void 0;
...
var switchDark = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(checked) {
    var res;
  ...
  return function switchDark(_x6) {
    return _ref4.apply(this, arguments);
  };
}();

exports.switchDark = switchDark;
},{"axios":"../../node_modules/axios/index.js"}],"task.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.upcomingTask = exports.todayTask = exports.pendingTask = exports.markDone = exports.deleteTask = exports.createTask = exports.completedTask = exports.clearAllTask = void 0;
...
var createTask = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(content, endDate, today) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            //     <p>${res.data.data.task.content}</p>
            //     <div class="done" > <p id=${res.data.data.task._id} class="mad">Mark as Done</p>
            //     <div class="delete" id=${res.data.data.task._id}><p class"dtask"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="bin w-6 h-6">
            //     <path stroke-linecap="round" stroke-linejoin="round" d="M14.74 9l-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.084a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 013.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 00-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 00-7.5 0" />
            //   </svg>
            //   </p></div>
            //     </div>
            //   </div>`;
            // //   today.insertAdjacentHTML('beforeend',el);
            // }
...
var todayTask = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: 'http://127.0.0.1:8000/api/v1/task/tasks/mytask?task=today'
            });

          case 4:
            res = _context2.sent;
            console.log(res);
            if (res.data.status == 'ok') renderTodayTasks(parent, res.data.data.myTasks);else if (res.data.status = 'fail') {
  ...
  return function todayTask(_x4) {
    return _ref2.apply(this, arguments);
  };
}();

exports.todayTask = todayTask;

var upcomingTask = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(parent) {
    var res;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: 'http://127.0.0.1:8000/api/v1/task/tasks/mytask?task=upcoming'
            });

          case 4:
            res = _context3.sent;
            console.log(res);
            if (res.data.status == 'ok') renderUpcomingTasks(parent, res.data.data.myTasks);else if (res.data.status = 'fail') {
              parent.innerHTML = "<p class='note-err'>You don't have any Upcoming Task</p>";
            }
            _context3.next = 12;
            break;
  ...
  return function upcomingTask(_x5) {
    return _ref3.apply(this, arguments);
  };
}();

exports.upcomingTask = upcomingTask;

var completedTask = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(parent) {
    var res;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: 'http://127.0.0.1:8000/api/v1/task/tasks/mytask?task=completed'
            });

          case 4:
            res = _context4.sent;
            console.log(res);
            if (res.data.status == 'ok') renderCompletedTasks(parent, res.data.data.myTasks);else if (res.data.status = 'fail') {
              parent.innerHTML = "<p class='note-err'>You don't have any completed Task</p>";
            }
            _context4.next = 12;
            break;
  ...
  return function completedTask(_x6) {
    return _ref4.apply(this, arguments);
  };
}();
...
var pendingTask = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(parent) {
    var res;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: 'http://127.0.0.1:8000/api/v1/task/tasks/mytask?task=pending'
            });
          ...
          case 4:
            ...
            if (res.data.status == 'ok') {
              ...
              parent.innerHTML = "<p class='note-err'>You don't have any pending Task</p>";
  ...
  return function pendingTask(_x7) {
...
var markDone = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(parent, id) {
    var res;
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://127.0.0.1:8000/api/v1/task/tasks/done/".concat(id)
            });
  ...
  return function markDone(_x8, _x9) {
...
var renderTodayTasks = function renderTodayTasks(parent, data) {
  parent.innerHTML = "";
  data.forEach(function (task) {
    ...
    // .done
    //   p Mark as Done
    var el = "<div class=\"task-card today-card\">\n    <p>".concat(task.content, "</p>\n    <div class=\"done\" > <p id=").concat(task._id, " class=\"mad\">Mark as Done</p>\n    <div class=\"delete\" id=").concat(task._id, "><p class\"dtask\"><svg xmlns=\"http://www.w3.org/2000/svg\" fill=\"none\" viewBox=\"0 0 24 24\" stroke-width=\"1.5\" stroke=\"currentColor\" class=\"bin w-6 h-6\">\n    <path stroke-linecap=\"round\" stroke-linejoin=\"round\" d=\"M14.74 9l-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.084a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 013.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 00-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 00-7.5 0\" />\n  </svg>\n  </p></div>\n    </div>\n  </div>");
    parent.insertAdjacentHTML('beforeend', el);
  });
};

var renderUpcomingTasks = function renderUpcomingTasks(parent, data) {
  parent.innerHTML = "";
  data.forEach(function (task) {
    var el = "<div class=\"task-card upcoming-card\">\n    <p>".concat(task.content, "</p>\n    <div class=\"next\"> <p id=").concat(task._id, ">").concat(new Date(task.endDate).toLocaleString('en-IN', {
      year: 'numeric',
      month: 'short',
      day: 'numeric',
      weekday: 'short'
...
var renderCompletedTasks = function renderCompletedTasks(parent, data) {
  parent.innerHTML = "";
  data.forEach(function (task) {
    var el = "<div class=\"task-card completed-card \">\n    <p>".concat(task.content, "</p>\n  </div>");
    parent.insertAdjacentHTML('beforeend', el);
  });
};

var renderPendingTasks = function renderPendingTasks(parent, data) {
  parent.innerHTML = "";
  data.forEach(function (task) {
    // .task-card.today-card
    // p #{task.content}
    // .done
    //   p Mark as Done
    var el = "<div class=\"task-card pending-card\">\n    <p>".concat(task.content, "</p>\n    <div class=\"done\"> <p id=").concat(task._id, " class=\"mad\">Mark as Done</p></div>\n  </div>");
    parent.insertAdjacentHTML('beforeend', el);
  });
};

var deleteTask = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(id, parent) {
    var res;
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'DELETE',
              url: "http://127.0.0.1:8000/api/v1/task/".concat(id)
            });
  ...
  return function deleteTask(_x10, _x11) {
...
var clearAllTask = /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(parent) {
    var res;
  ...
  return function clearAllTask(_x12) {
    return _ref8.apply(this, arguments);
  };
}();

exports.clearAllTask = clearAllTask;
...
var dashboardWrapper = document.querySelector('.dashboard-section'); //SIGNUP......

if (signupForm) {
  var form = document.querySelector('.signup-form form');
  var name = document.querySelector('.name input');
  var email = document.querySelector('.email input');
  var eye = document.querySelector('.eye-password');
  var password = document.querySelector('.password input');
  var eyeC = document.querySelector('.eye-close');
  var eyeO = document.querySelector('.eye-open');
  form.addEventListener('submit', function (e) {
    e.preventDefault();
    console.log('clicked');
    (0, _auth.signup)(name.value, email.value, password.value);
  });
...
if (loginForm) {
  var _form = document.querySelector(' .login-form form');

  var _email = document.querySelector('.email input');

  var _eye = document.querySelector('.eye-password');

  var _password = document.querySelector('.password input');

  var _eyeC = document.querySelector('.eye-close');

  var _eyeO = document.querySelector('.eye-open');

  _form.addEventListener('submit', function (e) {
    e.preventDefault();
    console.log('login-from');
    (0, _auth.login)(_email.value, _password.value);
  });

  _eye.addEventListener('click', function () {
    _eyeC.classList.toggle('eye-close-state');

    _eyeO.classList.toggle('eye-open-state');

    if (_eyeC.classList.contains('eye-close-state')) {
      _password.type = 'text';
    } else _password.type = 'password';
  });
} //DASHBOARD.....
...
if (dashboardWrapper) {
  ...
  var send = document.querySelector('.send-svg');
  var todayBtn = document.querySelector('.today-title');
  var createBtn = document.querySelector('.create');
  var overlay = document.querySelector('.overlay');
  var taskWrapper = document.querySelector('.task-create-wrapper');
  var cross = document.querySelector('.cross-svg');
  var bd = document.documentElement;
  var mainSection = document.querySelector('.main-section');
  var taskContainer = document.querySelector('.my-task-container');
  var lists = document.querySelectorAll('.task-titles li');
  var myTask = document.querySelector('.my-task');
  ...
  send.addEventListener('click', function () {
    var content = document.querySelector('.task-text');
    var endDate = document.querySelector('.date-pick').value;
    var endFinalDate = new Date("".concat(endDate, ":0:0:0"));
    overlay.classList.remove('overlay-state');
    var todayWrapper = document.querySelector('.today');
    taskWrapper.classList.remove('task-wrapper-state');
    (0, _task.createTask)(content.value, endFinalDate, todayWrapper);
  });
  var textarea = document.querySelector('textarea');
  textarea.addEventListener('keyup', function () {
    var sendSvg = document.querySelector('.send-svg');
    if (this.value == "" || !this.value) sendSvg.classList.remove('send-svg-state');else sendSvg.classList.add('send-svg-state');
  });
  ...
  lists.forEach(function (list) {
    list.addEventListener('click', function (e) {
      var el = list.dataset.title;
      var wrapper = document.querySelector(".".concat(el));
      var activeEl = document.querySelector('.active-wrapper');
      var titlesStateEl = document.querySelector('.titles-state');
  ...
  var today = document.querySelector('.today-title');
  var todayWrapper = document.querySelector('.today');
  today.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var doneP, deleteBtn;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return (0, _task.todayTask)(todayWrapper);

          case 3:
            doneP = document.querySelectorAll('.mad');
            doneP.forEach(function (md) {
              md.addEventListener('click', function () {
                var parent = md.closest('.task-card');
                var id = md.getAttribute('id');
                console.log('pp---', id);
                (0, _task.markDone)(parent, id);
              });
            });
            ...
            if (deleteBtn) {
              ...
              deleteBtn.forEach(function (task) {
                task.addEventListener('click', function () {
                  console.log('delete-clickde');
                  var parent = this.closest('.task-card');
                  (0, _task.deleteTask)(this.getAttribute('id'), parent);
                });
              });
            }
  ...
  var upcoming = document.querySelector('.upcoming-title');
  var upcomingWrapper = document.querySelector('.upcoming');
  upcoming.addEventListener('click', function () {
    console.log('upcoming-clicked!');
    (0, _task.upcomingTask)(upcomingWrapper);
  }); //CALLING COMPLETED.....

  var completed = document.querySelector('.completed-title');
  var completedWrapper = document.querySelector('.completed');
  var clearAll = document.querySelector('.clear-all p');
  completed.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 3;
            return (0, _task.completedTask)(completedWrapper);
  ...
  var pending = document.querySelector('.pending-title');
  var pendingWrapper = document.querySelector('.pending');
  pending.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var doneP;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 3;
            return (0, _task.pendingTask)(pendingWrapper);
  ...
  menuList.forEach(function (list) {
    list.addEventListener('click', function () {
      var curListState = document.querySelector('.menu-state');
  ...
  var sidebarSwitch = document.querySelector('.sidebar');
  var mainSwitch = document.querySelector('.main-section');
  var taskSwitch = document.querySelector('.task-titles');
  var darkSvg = document.querySelector('.svg-dark');
  var svgMode = document.querySelector('.svg-dark');
